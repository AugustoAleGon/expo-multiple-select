...
This project is a monorepo managed using [Bun workspaces](https://bun.sh/docs/pm/workspaces). It contains the following packages:
...
> Since the project relies on Bun workspaces, you cannot use [`npm`](https://github.com/npm/cli) for development without manually migrating.
...
```sh
Running "ExpoMultipleSelectExample" with {"fabric":true,"initialProps":{"concurrentRoot":true},"rootTag":1}
```
...
- `bun run lint`: lint files with [ESLint](https://eslint.org/).
